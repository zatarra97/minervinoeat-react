...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Overlay per mobile */}
      <div 
        data-drawer-backdrop="static" 
        data-drawer-target="logo-sidebar" 
        aria-hidden="true" 
        className="fixed inset-0 bg-gray-900/50 dark:bg-gray-900/80 hidden"
      />
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          {/* Close button - visibile solo su mobile */}
          <button
            type="button"
            data-drawer-target="logo-sidebar"
            data-drawer-toggle="logo-sidebar"
            aria-controls="logo-sidebar"
            className="sm:hidden absolute top-2.5 right-2.5 inline-flex items-center p-1.5 text-sm text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg"
          >
